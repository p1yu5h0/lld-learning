...
public class CheckoutService {
    ...
    public void processCheckout(Order order, String promoCode, PaymentStrategy paymentMethod, double decoratedAmount) {
        ...
        double finalAmount = decoratedAmount - (decoratedAmount * discountMultiplier);
